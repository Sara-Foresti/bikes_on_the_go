...
# arthur = User.find_by(email: "arthur@lewagon.com")
# if condition

# end
# arthur.bikes.destroy_all
# arthur.destroy


arthur = User.create!(email: "arthur@lewagon.com", password: "123456", first_name: "Arthur", last_name: "Littmann")
Bike.create!(
